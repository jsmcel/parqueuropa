...
const ResultScreen = ({ route, navigation }) => {
  ...
  const handleShare = async () => {
    ...
    try {
      await Share.share({
        message: `¡Descubrí la pieza "${pieceName}" en el Museo del Ferrocarril con la app Guía Ferroviaria! #MuseoFerrocarril`, // Añadir hashtag
        title: `Pieza: ${pieceName}` // Título más específico
      });
    } catch (error) {
