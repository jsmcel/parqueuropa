...
import config from '../config.js'; // Para colores
    ...
    <View style={styles.audioPlayerContainer}>
      ...
      <View style={styles.audioControls}>
        <TouchableOpacity
          ...
          disabled={isLoading}
        >
          <Ionicons name="play-skip-back-outline" size={28} color={isLoading ? config.COLORS.LIGHT_ACCENT : config.COLORS.PRIMARY} />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          disabled={true}
        >
          <Ionicons name="play-skip-forward-outline" size={28} color={config.COLORS.LIGHT_ACCENT} />
        </TouchableOpacity>
      </View>
  ...
  return (
    <View style={styles.audioPlayerContainer}>
      {isLoading && !isPlaying ? (
          ...
          <View style={styles.loadingContainer}>
              <Ionicons name="alert-circle-outline" size={40} color={config.COLORS.SECONDARY} />
        ...
        <>
          ...
          <View style={styles.audioControls}>
             ...
             >
                <Ionicons name="play-skip-back-outline" size={28} color={!sound ? config.COLORS.LIGHT_ACCENT : config.COLORS.PRIMARY} />
             </TouchableOpacity>
              <TouchableOpacity
...
const AudioPlayer = forwardRef((props, ref) => {
  // En web, usar el componente nativo HTML
  if (Platform.OS === 'web') {
    return <WebAudioPlayer {...props} ref={ref} />;
  }
  
  // En móvil, usar expo-av (código original intacto)
  return <MobileAudioPlayer {...props} ref={ref} />;
});
...
const styles = StyleSheet.create({
  ...
  progressBarBackground: {
    height: 16,
    justifyContent: 'center',
    backgroundColor: config.COLORS.LIGHT_ACCENT + '50',
    borderRadius: 8,
    overflow: 'hidden',
  },
  progressBarFill: {
