...
const HomeScreen = ({ navigation }) => {
  ...
  const bannerImage = config?.ASSETS?.heroBanner;
  const placeholderSmall = config?.ASSETS?.placeholderSmall;
  const fallbackPlaceholderSmall = placeholderSmall || require('../../shared/assets/images/placeholder_small.png');
            ...
            <View style={styles.recentPiecesContainer}>
              {recentPieces.map((p, i) => {
                 ...
                 return (
                   ...
                   >
                     <Image source={uri ? { uri } : fallbackPlaceholderSmall} style={styles.recentPieceImage} defaultSource={fallbackPlaceholderSmall} />
